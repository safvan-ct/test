            ...
            <div class="container">
                <article class="ps-product--header-sticky">
                    ...
                    <div class="ps-product__wrapper">
                        <div class="ps-product__content"><a class="ps-product__title"  style="color: white;">{{ $account->name }}</a>
                            
                        </div>
                        <div class="ps-product__shopping"><span class="ps-product__price"><span style="color: white;">   ₹ {{ $account->offer_rate }}</span>
                            </span><a class="ps-btn" href="{{ route('add.to.cart', $account->id) }}" style="background-color: #f4aa12;"> Add to Cart</a></div>
                    </div>
                </article>
            </div>
        </nav>
