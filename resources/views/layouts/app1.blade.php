...
<body>
        ...
        <nav class="navigation" style="background-color: black;">
            <div class="container">
                <article class="ps-product--header-sticky">
                    <div class="ps-product__thumbnail"><img src="img/images/vitamin-c.png" alt="" /></div>
                    <div class="ps-product__wrapper">
                        <div class="ps-product__content"><a class="ps-product__title"
                                style="color: white;">{{ $account->name }}</a>

                        </div>
                        <div class="ps-product__shopping"><span class="ps-product__price"><span style="color: white;"> ₹
                                    {{ $account->offer_price }}</span>
                            </span><a class="ps-btn" href="{{ route('add.to.cart', $account->id) }}"
                                style="background-color: #f4aa12;"> Add to Cart</a></div>
                    </div>
                </article>
            </div>
        </nav>
        ...
        <div class="header__content" style="background-color:black;">
            <div class="container">
                ...
                <div class="header__content-center">
                    <a href="{{ route('index') }}" style="padding-left: 169px;"><img
                            src="{{ asset('storage/images/logo_goldnew.png') }}" alt=""
                            style="width: 214px;"></a>
    ...
    border: none;"><i
                                                class="fa fa-search" style="font-size:23px;color:white"></i></button>
                                </form>
                    ...
                    @auth
                        <div class="ps-block--user-header">
                            <a href="{{ route('logout') }}"
                                ...
                                class="nav-link"><i class="fa fa-sign-out" aria-hidden="true"
                        ...
                        <div class="ps-cart--mini"><a class="header__extra" href="{{ route('cart') }}"><i
                                    class="icon-bag2"
                                    style="color: white"></i><span><i>[{{ cartCount() }}]</i></span></a>
                        </div>
                ...
                <div class="header__content-right" style="color: white;position: relative;">
                    <div class="header__actions">
                      <div class="ps-cart--mini">
                        ...
                        @auth
                        <div class="ps-cart--mini" ><a class="header__extra" href="{{ route('cart') }}"><i class="icon-bag2" style="color: white"></i><span><i>[{{ cartCount() }}]</i></span></a>
                        </div>
                        @endauth
                        @guest
                        <div class="ps-cart--mini" ><a class="header__extra" href="{{ route('cart') }}"><i class="icon-bag2" style="color: white"></i><span><i>[{{ cartCount() }}]</i></span></a>
    ...
    <header class="header header--mobile autopart" data-sticky="true">
        ...
        <div class="navigation--mobile" style="background-color:black;">
            <div class="navigation__left"><a class="ps-logo" href="{{ route('index') }}"><img
                        src="{{ asset('storage/images/logo_goldnew.png') }}" alt=""
                        style="width: 145px;"></a></div>
                ...
                <div class="ps-cart__content">
                    <div class="ps-product--cart-mobile">
                        <div class="ps-product__thumbnail"><a href="#"><img
                                    src="https://lesenorita.com/amigohosting/storage/uploads/account/1657598773.png"
                                    alt=""></a></div>
                        <div class="ps-product__content"><a class="ps-product__remove" href="#"><i
                                    class="icon-cross"></i></a><a href="product-default.html">Glutathione Foaming Face
                                Wash</a>
    ...
    <div class="ps-panel--sidebar" id="navigation-mobile">
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                <li class="menu-item-has-children has-mega-menu"><a href="{{ route('shop', 6) }}">FACE</a><span
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="{{ route('shop', 5) }}">HAIR</a><span
                        class="sub-toggle"></span>
                    <div class="mega-menu">
                        <div class="mega-menu__column">
                            <h4>Hair Shampoo</h4>
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="{{ route('shop', 4) }}">SKIN</a><span
                        class="sub-toggle"></span>
                    <div class="mega-menu">
                        <div class="mega-menu__column">
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="{{ route('shop', 2) }}">WOMEN</a><span
                        class="sub-toggle"></span>
                    <div class="mega-menu">
                        <div class="mega-menu__column">
                            <h4>VT Gel</h4>
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="{{ route('shop', 1) }}">MEN</a><span
                        class="sub-toggle"></span>
                    <div class="mega-menu">
