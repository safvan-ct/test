...
<style>
 ...
 <div class="ps-page--single" id="contact-us">
   ...
   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.438062148875!2d76.293821!3d9.980625999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d49dd87ed8d%3A0x7c3fb3d6276b77e5!2sAmigo%20Medical%20Systems!5e0!3m2!1sen!2sin!4v1659006127955!5m2!1sen!2sin" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                ...
                                <p><a href="mailto:amigocarein@gmail.com"><span class="__cf_email__" data-cfemail="caa9a5a4beaba9be8aa7abb8beacbfb8b3e4a9a5a7">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                <h4>Head Quater</h4>
                                <p><span>38/29953 G , 1st floor, Joseph tower, CBI road, Kathrikadavu, kaloor, kochi 682017.</span></p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                <h4>Work With Us</h4>
                                <p><span>Send your CV to our email:</span><a href="mailto:amigocarein@gmail.com"><span class="__cf_email__" data-cfemail="593a382b3c3c2b1934382b2d3f2c2b20773a3634">amigocarein@gmail.com</span></a></p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                <h4>Customer Service</h4>
                                <p><a href="mailto:amigocarein@gmail.com"><span class="__cf_email__" data-cfemail="d3b0a6a0a7bcbeb6a1b0b2a1b693beb2a1a7b5a6a1aafdb0bcbe">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                ...
                                <p><a href="mailto:amigocarein@gmail.com"><span class="__cf_email__" data-cfemail="8be6eeefe2eacbe6eaf9ffedfef9f2a5e8e4e6">amigocarein@gmail.com</span></a><span></span></p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-block--contact-info">
                                <h4>Vendor Support</h4>
                                <p><a href="mailto:amigocarein@gmail.com"><span class="__cf_email__" data-cfemail="d4a2b1bab0bba6a7a1a4a4bba6a094b9b5a6a0b2a1a6adfab7bbb9">
                ...
                <form class="ps-form--contact-us contact"  action="{{ route('contact') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <div class="form-group">
                                <input class="form-control"  name="phone" id="phone_number" type="number" placeholder="Phone *">
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <div class="form-group">
