<head lang="en">
    <meta charset="utf-8">
     <title>Delivery Details</title>
        <meta name="description" content="We're dedicated to giving you the very best of our products and Services, with a focus on dependability, customer service and uniqueness">
                       ...
                       @if(session('cart'))
                        ...
                        @php $total += $details['price'] * $details['quantity'] @endphp
                                 ...
                                 <tr>
                                    ...
                                    <td class="thick-line text-right">{{ $details['name'] }}</td>

                                    <td class="thick-line text-right">{{ $details['price']}}</td>

                                    <td class="thick-line text-right">{{ $details['quantity'] }}</td>
                                    <td class="thick-line text-right">{{ $details['price'] * $details['quantity'] }}</td>
                            ...
                            <div class="card-body text-center" style="padding-bottom:100px">
                                <form action="{{ route('razorpay.payment.store') }}" method="POST">
                                    ...
                                    <script src="https://checkout.razorpay.com/v1/checkout.js"
                                            ...
                                            data-image="{{ asset('storage/images/logo_goldnew.png') }}"
