...
@section('content')
<div class="page-banner about-banner" style="background-image: url({{asset('/storage/images/bg.gif')}});padding-top: 100px" >
					...
					<div class="contact-form">
						...
						<div class="row" style="padding-top: 48px;">
							...
							<div class="col-lg-12 col-md-12">
								...
								<center><h3> {{ auth()->user()->email }}  </h3></center>
							...
							<div class="col-lg-12 col-md-12">
                                	<a href="{{ route('profileedit') }}">  <button   style="width: -webkit-fill-available;" type="button" class="ps-btn ps-btn--fullwidth">Change Password</button>
								</a></div>
    ...
    width: 100%;
				...
				<div class="col-lg-12 col-md-12">
					<div class="" id="myform" >
						...
						<center><h2><u>Order History</u></h2></center>
						</br>
                        ...
                        @foreach ($orders as $order )
                             @php
								$pname = trim(str_replace(array(','), '<br><br> ', $order->product));

                                $product_id1 = explode(',', $order->pid);
								$rate = trim(str_replace(array(','), '<br><br> ',$order->ptprice));
								$quantity =trim( str_replace(array(','), '<br><br> ',$order->pquantity));
                                @endphp
                       ...
                       <td></td>
                           ...
                           <td class="product-name" data-title="Date">
                               <a href="#"></br></br> {{ date('d-m-Y', strtotime($order->date)) }} </a>
                           </td>
                           <td></td>
                       ...
                       <tr style="outline: thin solid; color:green"><hr></hr></tr>
