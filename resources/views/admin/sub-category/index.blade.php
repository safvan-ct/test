    ...
    <script type="text/javascript">
        ...
        function results() {
            $('#data-table').DataTable({
                ...
                serverSide: true,
                destroy: true,
                ajax: "{{ route('sub.category.result') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
        ...
        function createUpdateModal(id) {
            ...
            $('#heading').html('New Sub Category');
            $('#createUpdateForm')[0].reset();

            if (id != 0) {
                $('#heading').html('Update Sub Category');
                $('#category_id').val($('#category_id_' + id).html());
        ...
        function createUpdatePost() {
            var url = "{{ route('sub.category.create.update') }}";
