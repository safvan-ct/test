                            ...
                            <tbody>
                                @foreach ($datas as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit{{ $brand->id }}">Edit</button>

                                            <a class="delete_btn btn btn-danger" data-action="{{ $brand->id }}" message="Delete the brand">
                                                Delete
                                            </a>

                                            <form style="display: none" id="{{ $brand->id }}" method="post"
