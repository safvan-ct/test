    ...
    <script type="text/javascript">
        ...
        function results() {
            $('#data-table').DataTable({
                ...
                serverSide: true,
                destroy: true,
                ajax: "{{ route('product.Ingredient.result') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
        ...
        function createUpdateModal(id) {
            ...
            $('#image').hide();
            $('#heading').html('New Product Ingredient');
            $('#createUpdateForm')[0].reset();

            if (id != 0) {
                $('#heading').html('Update Product Ingredient');
                $('#product_id').val($('#product_id_' + id).html());
        ...
        function createUpdatePost() {
            var url = "{{ route('product.Ingredient.create.update') }}";
