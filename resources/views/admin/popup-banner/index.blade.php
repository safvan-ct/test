                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="duration" id="duration" required value="0">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Image</label>
    ...
    <script type="text/javascript">
        ...
        function results() {
            $('#data-table').DataTable({
                ...
                serverSide: true,
                destroy: true,
                ajax: "{{ route('popup.banner.result') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
