...
<div class="ps-layout--shop">
    <div class="ps-layout__left">
        <aside class="widget widget_shop">
                            ...
                            <ul class="ps-list--categories">
                                ...
                                <li class="menu-item-has-children"><a href="shop-default.html">{{ $cat1->title }}</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                                    <ul class="sub-menu">

                                         @foreach($subcategorys as $subcategory1)
                                           @if($subcategory1->game==$cat1->id)
                                        <li><a href="{{ route('shopcat',$subcategory1->id) }}" style="color:white">{{$subcategory1->title}}</a>
                                        </li>
                                            @endif
                                         @endforeach
    ...
    <div class="ps-layout__right" style="padding-top:22px">
                     ...
                     @endphp
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                <div class="ps-product">
                                    <div class="ps-product__thumbnail"><a href="{{ route('account_details',$b[$s]) }}"><img src="{{ asset('/storage/' . $im[$s]) }}" alt="" /></a>
                                        <ul class="ps-product__actions" style="background: black; color: white; width:150px;">
                                            <!--<li><a href="{{ route('add.to.cart',$b[$s]) }}" data-toggle="tooltip" data-placement="top" style="margin-right: 34px;margin-left: 25px;width: 90px;">Add to Cart</a></li>-->

                                             <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li> 

                                        </ul>
                                    </div>
                                    <div class="ps-product__container"><a class="ps-product__vendor" href="{{ route('account_details',$b[$s]) }}"></a>
                                        <div class="ps-product__content"><a class="ps-product__title" href="{{ route('account_details',$b[$s]) }}">{{ $a[$s] }}</a>
                                            <p class="ps-product__price sale">
                                            @if($offer[$s] != 0)
                                            <del>₹&nbsp&nbsp{{ $rate[$s]}}</del>
                                            @endif ₹&nbsp&nbsp{{ $offer_rate[$s] }} </p>
                                        </div>
                                        <div class="ps-product__content hover"><a class="ps-product__title" href="{{ route('account_details',$b[$s]) }}">{{ $a[$s] }}</a>
                                               <p class="ps-product__price sale">  @if($offer[$s] !=0)
                                            <del>₹&nbsp&nbsp{{ $rate[$s]}}</del>
                                            @endif ₹&nbsp&nbsp{{ $offer_rate[$s] }}</p>
                                     </div>
                                    </div>
